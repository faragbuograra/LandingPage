  ...
  return (
    <>
      <div className="flex flex-wrap-reverse sm:flex-wrap mt-5 overflow-hiden">
        <div className="flex  mx-3 sm:mx-0 sm:items-center sm:justify-center w-full lg:w-1/2 overflow-hiden">
          <div className="relative  w-[305px] sm:w-[470px] h-[439.45px] sm:h-[600.00px]  justify-startr overflow-hiden">
            <Image
              src={"/page2.png"}
              width="492"
              height="658"
            ...
            <div className="absolute w-[335px] h-[439.45px] bottom-[-50px] right-[-50px] border-2 border-blue-500 hidden sm:block"></div>
          </div>
        </div>
      ...
      <div className="flex flex-wrapsm:flex-wrap mt-5 overflow-hiden">
        <div className=" mb-8 mx-5 sm:mx-0 justify-center w-full">
          <h1 className="text-[30px] sm:text-[50px] font-bold text-left sm:text-center   tracking-tight text-[#2C2C2C]  lg:leading-tight  xl:leading-tight">
            Cards are an essential <br></br> Element of aclear User Interface
          </h1>
        </div>
      </div>
